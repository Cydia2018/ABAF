...
# model_root = "/mnt/hdd1/benkebishe01/FCOS/fsaf"
model_root = "/mnt/hdd1/benkebishe01/paper_voc/diou"
...
if __name__ == "__main__":
    ...
    for name in names:
        ...
        for class_id, class_mAP in all_AP.items():
            mAP += float(class_mAP)
            with open('paper/diou/free/class'+str(class_id)+'.txt', 'a') as f:
        ...
        with open('paper/diou/free/mAP.txt', 'a') as f:
