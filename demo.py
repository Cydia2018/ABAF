...
if __name__=="__main__":
    ...
    model.load_state_dict(torch.load("/mnt/hdd1/benkebishe01/fcos/voc2012_512x800_epoch59_loss0.5531.pth"))
    ...
    for name in names:
        ...
        img1= transforms.Normalize((0.485,0.456,0.406), (0.229,0.224,0.225))(img1)
        img1=img1.cuda()
