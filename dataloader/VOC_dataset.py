...
class VOCDataset(torch.utils.data.Dataset):
    ...
    def collate_fn(self, data):
        ...
        for i in range(batch_size):
            ...
            pad_imgs_list.append(transforms.Normalize(self.mean, self.std)(torch.nn.functional.pad(img, (0, int(max_w - img.shape[2]), 0, int(max_h - img.shape[1])), value=0.)))
...
if __name__=="__main__":
    ...
    dataset=VOCDataset("D:/benkebishe/code/pytorch-retinanet-master/data/data/VOCdevkit/VOC2012",split='trainval')
    # for i in range(100):
